...
const firebaseConfig = {
    apiKey: "AIzaSyBpqfLOk0xfS-1pbyyitMup9BU5_Vob144",
    authDomain: "grocery-app-54e9a.firebaseapp.com",
    databaseURL: "https://grocery-app-54e9a.firebaseio.com",
    projectId: "grocery-app-54e9a",
    storageBucket: "grocery-app-54e9a.appspot.com",
    messagingSenderId: "488822688849",
    appId: "1:488822688849:web:4a8f627e397827754e3c70"
};
...
app.post("/getProductsByNumber", (req, res) => {
  ...
  productRef
    ...
    .then((data) => {
      ...
      if (data.empty) {
        return res.json({ success: false, msg: 'No more products' });
      }
